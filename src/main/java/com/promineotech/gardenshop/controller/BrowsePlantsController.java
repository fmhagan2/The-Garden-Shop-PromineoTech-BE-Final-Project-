...
@OpenAPIDefinition(info = @Info(title = "Browse Plants Service"), servers={
    @Server(url = "http://localhost:8080", description = "Local server.")
})

public interface BrowsePlantsController {
//@formatter:off
 @Operation(
     summary = "Returns a list of Plants",
     description = "Returns a list of Plants given an optional filter.",
     responses={
         @ApiResponse(
             responseCode = "200", 
